...
public class StationaryItem implements Serializable {
    ...
    public StationaryItem(String name, String img,
                          String atr1, String atr2,
                          String atr3, String atr4,
                          String id, String searchName,
                          String quantityFlag, Integer discount,
                          Integer discountedPrice, Integer originalPrice, Integer quantity, Boolean availability) {
        this.name = name;
        this.img = img;
        this.atr1 = atr1;
        this.atr2 = atr2;
