...
public class StationaryItemViewHolder extends RecyclerView.ViewHolder {
    ...
    public void setDetails(String brand, String pic, String atr1, String atr2, String atr3, String atr4,
                           Integer discount, Integer discountedPrice, Integer originalPrice, Boolean availability) {
        ...
        tDiscountedPrice.setText("₹ " + discountedPrice);
